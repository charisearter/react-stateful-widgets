...
export default function Programmers() {
	...
	const [programmer, setProgrammer] = useState(listOfAwesome); //state for aray of programmers
	const [featureId, setFeatureId] = useState(null); //state for id in array
	...
	const getNameOfFeatured = () => {
		...
		return programmer.filter((index) => featureId === index.id)[0].name;
	};
